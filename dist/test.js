...
const TransferDecoder_1 = require("./decoders/TransferDecoder");
const AddressLabeler_1 = require("./labeler/AddressLabeler");
const PriceResolver_1 = require("./utils/PriceResolver");
...
async function runTests() {
    ...
    const decoder = new TransferDecoder_1.TransferDecoder();
    // Create a mock provider (won't actually connect)
    const mockProvider = new ethers_1.ethers.JsonRpcProvider('https://eth-mainnet.g.alchemy.com/v2/mock');
    ...
    const labeler = new AddressLabeler_1.AddressLabeler();
    const testAddresses = [
    ...
    const priceResolver = new PriceResolver_1.PriceResolver();
    try {
