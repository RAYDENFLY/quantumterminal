...
export const API_URLS = {
  ...
  signals: [
    '/api/signals', // Local API
    'https://quantumbot-bice.vercel.app/api/signals',
    'https://e67255a0-cdbb-406b-9f86-78f58865e1b1-00-2s422x0ck3xxr.pike.replit.dev/api/signals'
  ]
};
